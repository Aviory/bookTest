...
public class TutorialTextFloatFragmentLibrary extends BaseFragment implements TutorialsDialog.OnItemTutorialsClick {

    private TutorialsDialog mTutorialsDialog;


    public static TutorialTextFloatFragmentLibrary getInstance() {
        TutorialTextFloatFragmentLibrary tutorialTextFloatFragment = new TutorialTextFloatFragmentLibrary();
