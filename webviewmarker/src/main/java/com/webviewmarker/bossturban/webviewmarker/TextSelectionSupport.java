...
package com.webviewmarker.bossturban.webviewmarker;
...
import com.webviewmarker.blahti.drag.DragController;
import com.webviewmarker.blahti.drag.DragController.DragBehavior;
import com.webviewmarker.blahti.drag.DragLayer;
import com.webviewmarker.blahti.drag.DragListener;
import com.webviewmarker.blahti.drag.DragSource;
import com.webviewmarker.blahti.drag.MyAbsoluteLayout;
    ...
    private Runnable mStartSelectionModeHandler = new Runnable() {
        public void run() {
            if (mSelectionBounds != null) {
                Log.d("SelectionSupport", "option 1 > ");
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            final String startTouchUrl = String.format
                    (Locale.US, "javascript:android.selection.startTouch(%f, %f);", xPoint, yPoint);
            mLastTouchX = xPoint;
            mLastTouchY = yPoint;
        ...
        mActivity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (mLastTouchedSelectionHandle == HandleType.START && startX > 0 && startY > 0){
                    Log.d("SelectionSupport", "option 1 > " + scale + " : " + startY + " : " + startX + " : " + endY);
                    Log.d("SelectionSupport", "option 11 > " + startHandleParams.width + " : " +
                            startHandleParams.height + " : " + endHandleParams.width + " : " + endHandleParams.height);
